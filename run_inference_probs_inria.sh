#!/bin/bash
# SLURM job template for INRIA probability inference.
# Parallels run_inference_probs.sh but calls run_inference_probs_inria.py
# (MAMNet only, no OGLANet/DINOv3).
#
# --- Gilbreth ---
...
#   MODEL_VARIANT, TEST_TYPE, CITY, TRAIN_RES, TEST_RES
...
echo "=========================================="
echo "INRIA PROBABILITY INFERENCE"
echo "=========================================="
...
$PYTHON_BIN run_inference_probs_inria.py \
