#!/bin/bash
# FILENAME: final_comparison.sh
#
# SLURM job script for final_comparison.py.
# Called by final_comparison_submit.sh.
...
# =====================================================================
# Distributed env vars (no GPU needed for this job, but kept for parity)
# =====================================================================
...
$PYTHON_BIN -u final_comparison.py \
    --base_path "${BASE_PATH}" \
