...
#
#   This directly encourages the model to maintain stable confidence
#   for shadow predictions under domain perturbation (content augmentation),
#   addressing the selective-prediction collapse observed under LOCO.
#
...
if __name__ == "__main__":
    ...
    main_logits = torch.randn(2, 2, 256, 256)
