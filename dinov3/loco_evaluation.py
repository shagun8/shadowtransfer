...
def load_model(checkpoint_path, device, model_name='dinov3_vits16', 
...
def main():
    ...
    within_pattern = f'dinov3_{test_city}_{args.resolution}_*'
    ...
    loco_pattern = f'dinov3_loco_holdout_{test_city}_{args.resolution}_*'
    ...
    # Load models
    within_model = load_model(within_checkpoint, device, 
                         args.model_name, args.weights_path, 
                         args.pretrained, args.frozen_stages)
    loco_model = load_model(loco_checkpoint, device,
                       args.model_name, args.weights_path,
                       args.pretrained, args.frozen_stages)
