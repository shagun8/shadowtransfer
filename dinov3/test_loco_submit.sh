...
OUTPUT_DIR="${PROJECT_ROOT}/data/dinov3/outputs"
LOG_DIR="${PROJECT_ROOT}/data/dinov3/loco_eval_logs"
WEIGHT_DIR="${PROJECT_ROOT}/python/dinov3/weights/dinov3_vits16_pretrain_lvd1689m-08c60483.pth"
...
do
    ...
    do
        ...
        sbatch --output=${outputfile} \
               --job-name=${name} \
               --export=PROJECT_ROOT=${PROJECT_ROOT},RESOLUTION=${res},FOLD_ID=${fold_id},BASE_DATA_ROOT=${BASE_DATA_ROOT},OUTPUT_DIR=${OUTPUT_DIR},WEIGHT_DIR=${WEIGHT_DIR} \
               test_loco.sh
